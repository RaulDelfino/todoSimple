package com.RaulDelfino.todosimple.exceptions;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    // StackTrace nem sempre pode ser mostrado no terminal, então devemos configurar de acordo com o ambiente de desenvolvimento

    // Metodo para quem n colocar senha
    ...
    @ResponseStatus(HttpStatus.CONFLICT) // Status para comflito
    ...
    @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY) // criar usuario sem passar senha
